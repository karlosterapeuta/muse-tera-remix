...
function DashboardMockup() {
  return <div className="dashboard-mockup" aria-label="Prévia do dashboard MuseTera"><div className="dashboard-topbar"><span className="window-dots"><i /><i /><i /></span><span>portal.musetera.com.br</span><span className="dashboard-topbar__status"><span /> Online</span></div><div className="dashboard-body"><div className="dashboard-sidebar"><div className="dashboard-sidebar__brand"><img src={brandMark} alt="" /></div><span className="side-active"><BarChart3 size={13} /></span><span><UsersRound size={13} /></span><span><CalendarDays size={13} /></span><span><FileText size={13} /></span></div><div className="dashboard-content"><div className="dashboard-heading"><div><small>VISÃO GERAL</small><h3>Sua prática, em sintonia.</h3></div><span className="dashboard-date">Hoje, 16:30</span></div><div className="dashboard-metrics"><div><small>Pacientes</small><strong>128</strong><em>+12% este mês</em></div><div><small>Sessões</small><strong>342</strong><em>em acompanhamento</em></div><div><small>Planos ativos</small><strong>86</strong><em>tudo atualizado</em></div></div><div className="dashboard-chart"><div className="chart-title"><span>Evolução dos pacientes</span><small>últimos 30 dias</small><b>+18,4%</b></div><div className="chart-bars">{[32,44,37,52,58,66,74,65,82,88].map((height, index) => <i key={index} style={{ height: `${height}%` }} />)}</div></div><div className="dashboard-next"><span className="next-icon"><Clock3 size={15} /></span><div><small>PRÓXIMA SESSÃO</small><strong>Hoje, 16:30 · Pedro Henrique</strong></div><span className="next-arrow"><ArrowRight size={15} /></span></div></div></div><div className="dashboard-toast"><span><Check size={13} /></span><div><strong>Tudo sob controle</strong><small>Dados organizados e seguros</small></div></div></div>;
}
